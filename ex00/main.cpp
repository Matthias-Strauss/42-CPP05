...
/*   Updated: 2025/04/16 17:55:28 by mstrauss         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(void) {
  ...
  std::cout << "################ Testing Operator Overload << ###############"
            << std::endl;
  std::cout << std::endl;

  std::cout << "Initializing Bureaucrat using name:Anna, grade:100."
            << std::endl;
  Bureaucrat B0 = Bureaucrat("Anna", 100);
  std::cout
      << "testing operator overload by calling 'std::cout << B0 << std::endl'."
      << std::endl;
  std::cout << B0 << std::endl;
  std::cout << std::endl;
  std::cout << std::endl;

  std::cout << "######## Testing Constructor with invalid GRADE #############"
            << std::endl;
  std::cout << std::endl;
  ...
  std::cout << "################ Testing incrementGrade() ###################"
            << std::endl;
  std::cout << std::endl;
  // init with correct grade
  std::cout << "Init B3 with valid arguments (name:Dennis, score:2) on heap "
               "using 'new'."
            << std::endl;
  Bureaucrat *B3 = new Bureaucrat("Dennis", 2);
  // increment grade
  std::cout << "Increment B3's grade from 2 to 1 using .incrementGrade()"
            << std::endl;
  B3->incrementGrade();
  std::cout << "B3's grade is: " << B3->getGrade() << std::endl;
  // increment grade past threshhold
  std::cout << "Incrementing B3's grade from 1 to 0 using .incrementGrade()"
            << std::endl;
  ...
  std::cout << std::endl;
  {
    std::cout << "################ Testing decrementGrade() ###################"
              << std::endl;
    std::cout << std::endl;

    // init with correct grade
    std::cout << "Init B4 with valid arguments (name:Eve, score:149) on stack."
              << std::endl;
    ...
    try {
      std::cout << "Decrementing B4's grade using .decrementGrade()"
                << std::endl;
  ...
  std::cout << "################ Testing Setters & Getters ##################"
            << std::endl;
  {
    std::cout << std::endl;
    ...
    // setter & getter check
    std::cout
        << "Initializing Bureaucrat B5 with the arguments name:Frank, grade:42"
        << std::endl;
  ...
  std::cout << "############## Testing setGrade() Exceptions ################"
            << std::endl;
  std::cout << std::endl;

  {
    std::cout << "Initializing Bureaucrat B6 with arguments name:Hans, grade:42"
              << std::endl;
  ...
  {
    std::cout
        << "Initializing Bureaucrat B7 with arguments name:Irwin, grade:42"
        << std::endl;
